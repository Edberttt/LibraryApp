...
class LoanViewModel: ObservableObject {
    ...
    func deleteLoan(loanID: String) {
        guard let url = URL(string: "http://localhost/libraryapp/delete_loans.php") else { return }

        var request = URLRequest(url: url)
        request.httpMethod = "POST"
        request.setValue("application/x-www-form-urlencoded", forHTTPHeaderField: "Content-Type")
        
        let postString = "loan_id=\(loanID)"
    ...
    func reactivateDeleteLoan(loanID: String) {
        guard let url = URL(string: "http://localhost/libraryapp/reactivate_delete_loans.php") else { return }
